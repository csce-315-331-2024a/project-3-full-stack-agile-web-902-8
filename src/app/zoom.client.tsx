...
export const ZoomIn = () => {
    ...
    return <button onClick={() => setScale(scale * 1.1)}>Zoom In</button>;
};

export const ZoomOut = () => {
    const { scale, setScale } = useScale();
    return <button onClick={() => setScale(scale / 1.1)}>Zoom Out</button>;
};

export const ResetZoom = () => {
    const { setScale } = useScale();
    return <button onClick={() => setScale(1)}>Reset Zoom</button>;
};
